...
public class Subscriber_E4_2 implements MqttCallback {
        @Override
        ...
        public void messageArrived(String topic, MqttMessage message) throws Exception {
            ...
            if (value <= 20) return;
            if (!topic.equals("casa/habitacion/cocina/temperatura") && !topic.equals("casa/habitacion/aseo/temperatura")) return;
        	System.out.println("-------------------------------------------------");
